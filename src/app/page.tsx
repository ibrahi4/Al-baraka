      ...
      <section className="relative bg-gradient-to-br from-[#1B2A41] via-[#0F1A2B] to-[#1B2A41] text-white overflow-hidden">
        ...
        <div className="relative container-custom py-12 md:py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            ...
            >
              <Badge className="bg-[#C9A961]/20 text-[#C9A961] border-[#C9A961]/30 hover:bg-[#C9A961]/30 mb-5 px-4 py-1.5">
              ...
              <p className="text-base md:text-lg text-white/80 leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
                خدمات نقل أثاث احترافية بفرق مدربة ومعدات حديثة في جميع محافظات مصر. التزام بالمواعيد، تغليف احترافي، وضمان كامل.
              </p>
        ...
        <div className="container-custom py-8 md:py-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              { icon: MapPin, title: "تغطية شاملة", desc: "27 محافظة" },
            ].map((f, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  ...
                  { title: "أسطول حديث من السيارات المجهزة", desc: "نقل آمن وسريع في جميع المحافظات" },
              ...
              <Card className="bg-gradient-to-br from-[#1B2A41] to-[#0F1A2B] border-0 text-white overflow-hidden relative">
                ...
                <CardContent className="p-8 md:p-10 relative">
                  ...
                  <p className="text-white/70 text-sm md:text-base mb-8 leading-relaxed">
                    رحلة طويلة من الالتزام والاحترافية في خدمة آلاف العملاء في جميع محافظات مصر
                  </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-sm md:text-base text-gray-600 leading-relaxed">
              أينما كنت، فرقنا المتخصصة تصل إليك بسرعة واحترافية
            </p>
          </motion.div>

          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
            {governorates.slice(0, 12).map((g, i) => (
              <motion.div
                key={g.slug}
                initial={{ opacity: 0, scale: 0.9 }}
              ...
              >
                <Link href={`/areas/${g.slug}`}>
                  <Card className="hover:border-[#C9A961] hover:shadow-md transition-all duration-300 group cursor-pointer border-gray-200">
