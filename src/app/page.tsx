          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-right order-1 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-6">
                <Button asChild size="lg" className="bg-[#C9A961] hover:bg-[#A8893F] text-white font-bold shadow-xl h-12 px-8">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      {["أول طلب", "لفترة محدودة", "حجز سريع", "خدمة احترافية"].map((item) => (
                        <span key={item} className="text-xs bg-white/10 border border-white/10 text-white/85 px-3 py-1 rounded-full">
                          {item}
                        </span>
                      ))}
                    </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex gap-3 bg-white p-4 rounded-xl border border-gray-100 hover:border-[#C9A961] hover:shadow-md transition-all">
        ...
        <div className="relative container-custom py-12 md:py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3">
              <Button asChild size="lg" className="bg-[#C9A961] hover:bg-[#A8893F] text-white font-bold h-12 px-8 shadow-xl">
                <a href={`tel:${siteConfig.phone}`}>
                  <Phone className="w-4 h-4 ml-2" />
                  اتصل الآن
                </a>
